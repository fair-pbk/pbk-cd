...
source("validation/R/pbk_cd_gastellu_2026/pbk_cd_gastellu_2026.R")

model_id <- "pbk_cd_gastellu_2026"
...
# Food exposure (ug/kg bw/day). The model multiplies DIET_ing by its internal
# body weight trajectory before transfer into GUT.
df1[,DIET_ing := 0.2]
...
# Observed times
time_val <- 0:(80*365)
time_obl <- seq(0,400000,length.out=250)
