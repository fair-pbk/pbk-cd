...
for (i in c(1:10)){
  ...
  expo_diet_cd <- ev(amt = rep(100, 10), 
                     ii=1,
                     cmt = "DIET", 
                     addl = 0)
  ...
  save(Cd_Urinecr, file = "Results/Cd_Urinecr_repet.RData")
  save(Cd_Urine, file = "Results/Cd_Urine_repet.RData")
  save(Cd_Kidney, file = "Results/Cd_Kidney_repet.RData")
  save(Cd_Blood, file = "Results/Cd_Blood_repet.RData")
